...
%DIF ADD paper/main.tex                           Sun May 31 10:08:34 2026
...
Our pipeline computes \DIFdelbegin \DIFdel{eight }\DIFdelend \DIFaddbegin \DIFadd{a comprehensive suite of }\DIFaddend quality metrics, including BERTScore,
...
\begin{itemize}
  ...
  \item \texttt{clinical-eval report}: aggregates scored
        responses and renders the \DIFdelbegin \DIFdel{six-section }\DIFdelend Markdown report.
\end{itemize}
...
\texttt{clinical-eval all \-\-config\DIFaddbegin \DIFadd{-path}\DIFaddend  configs/pipeline.yaml}.
